...
void handle_nfapi_hi_dci0_dci_pdu(PHY_VARS_eNB *eNB,int frame,int subframe,L1_proc_t *proc,
...
void handle_nfapi_hi_dci0_hi_pdu(PHY_VARS_eNB *eNB,int frame,int subframe,L1_proc_t *proc,
                                 nfapi_hi_dci0_request_pdu_t *hi_dci0_config_pdu)
{
...
void handle_nfapi_bch_pdu(PHY_VARS_eNB *eNB,L1_proc_t *proc,
                          nfapi_dl_config_request_pdu_t *dl_config_pdu,
                          uint8_t *sdu)
{
...
void handle_nfapi_dlsch_pdu(PHY_VARS_eNB *eNB,int frame,int subframe,L1_proc_t *proc,
                            nfapi_dl_config_request_pdu_t *dl_config_pdu,
...
void handle_nfapi_ul_pdu(PHY_VARS_eNB *eNB,L1_proc_t *proc,
                         nfapi_ul_config_request_pdu_t *ul_config_pdu,
