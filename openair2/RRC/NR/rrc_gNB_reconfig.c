...
void fill_default_nsa_downlinkBWP(NR_BWP_Downlink_t *bwp,
  ...
  *bwp->bwp_Common->pdcch_ConfigCommon->choice.setup->ra_SearchSpace=ss->searchSpaceId;
  ...
  nr_rrc_config_dl_tda(bwp->bwp_Common->pdsch_ConfigCommon->choice.setup->pdsch_TimeDomainAllocationList,
                       get_frame_type((int)*servingcellconfigcommon->downlinkConfigCommon->frequencyInfoDL->frequencyBandList.list.array[0], *servingcellconfigcommon->ssbSubcarrierSpacing),
                       servingcellconfigcommon->tdd_UL_DL_ConfigurationCommon,
                       curr_bwp);
