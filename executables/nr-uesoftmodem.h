...
#define CMDLINE_NRUEPARAMS_DESC {  \
    ...
    {"tx_subdev",                CONFIG_HLP_TX_SUBDEV,   0,               strptr:(char **)&tx_subdev,         defstrval:NULL, TYPE_STRING,   0},    \
    {"rx_subdev",                CONFIG_HLP_RX_SUBDEV,   0,               strptr:(char **)&rx_subdev,         defstrval:NULL, TYPE_STRING,   0},    \
