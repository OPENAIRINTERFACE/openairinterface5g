...
static inline void fh_if4p5_south_out(RU_t *ru) {
  if (ru == RC.ru[0]) VCD_SIGNAL_DUMPER_DUMP_VARIABLE_BY_NAME( VCD_SIGNAL_DUMPER_VARIABLES_TRX_TST, ru->proc.timestamp_tx&0xffffffff );
  LOG_I(PHY,"[OOOOOOOOOOOOOOOOOOOOUUUUUTTTTTTT] fh_if4p5_south_out: Sending IF4p5 for frame %d subframe %d\n",ru->proc.frame_tx,ru->proc.subframe_tx);
...
void fh_if4p5_south_in(RU_t *ru,int *frame,int *subframe) {
  ...
  LOG_I(PHY,"[IIIIIIIIIIIIIIIIIIIINNNNNNNN] fh_if4p5_south_in: RU %d, frame %d, subframe %d\n",ru->idx,*frame,*subframe);
...
void fh_if4p5_north_in(RU_t *ru,int *frame,int *subframe) {
  ...
  LOG_I(PHY,"fh_if4p5_north_in: RU %d, frame %d, subframe %d\n",ru->idx,*frame,*subframe);   
