...
void nrLDPC_bnProcPc_BG2_generator_AVX2(uint16_t Z,int R)
{
 ...
 // system("mkdir -p ../ldpc_gen_files");
  ...
  char fname[50];
  sprintf(fname,"../ldpc_gen_files/bnProcPc/nrLDPC_bnProcPc_BG2_Z%d_R%s_AVX2.c",Z,ratestr[R]);
  ...
  //fprintf(fd,"void nrLDPC_bnProc_BG1_Z%d_%s_AVX2(int8_t* bnProcBuf,int8_t* bnProcBufRes,  int8_t* llrRes ,  int8_t* llrProcBuf ) {\n",Z,ratestr[R]);
    
  fprintf(fd,"void nrLDPC_bnProcPc_BG2_Z%d_R%s_AVX2(int8_t* bnProcBuf, int8_t* bnProcBufRes,  int8_t* llrRes ,  int8_t* llrProcBuf ) {\n",Z,ratestr[R]);
