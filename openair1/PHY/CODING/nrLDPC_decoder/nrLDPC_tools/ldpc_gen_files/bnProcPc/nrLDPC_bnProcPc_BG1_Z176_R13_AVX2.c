#include <stdint.h>
#include <immintrin.h>
void nrLDPC_bnProcPc_BG1_Z176_R13_AVX2(int8_t* bnProcBuf,int8_t* bnProcBufRes,  int8_t* llrRes ,  int8_t* llrProcBuf ) {
