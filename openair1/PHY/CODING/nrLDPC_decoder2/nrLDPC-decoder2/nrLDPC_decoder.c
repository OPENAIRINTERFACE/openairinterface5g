...
//bnProc
///#include "nrLDPC_tools/ldpc_gen_files/bnProc/nrLDPC_bnProc_BG1_R13_AVX2.c"
//#include "nrLDPC_tools/ldpc_gen_files/bnProc/nrLDPC_bnProc_BG2_R15_AVX2.c"
   ...
   // int8_t* cnProcBufRes=p_procBuf->cnProcBufRes;
    ...
    if (BG==1)
    {
        switch (R)
        {
            ...
            {
                #ifdef __AVX512BW__
                nrLDPC_cnProc_BG1_R13_AVX512(p_lut,p_procBuf, Z);
                #else
                nrLDPC_cnProc_BG1_R13_AVX2(p_lut, p_procBuf, Z);
                #endif
                break;
           }
            ...
            {
                #ifdef __AVX512BW__
                 nrLDPC_cnProc_BG1_R23_AVX512(p_lut,p_procBuf, Z);
                //nrLDPC_cnProc_BG1_R13_AVX512(p_procBuf->cnProcBuf,p_procBuf->cnProcBufRes);
                #else
                nrLDPC_cnProc_BG1_R23_AVX2(p_lut, p_procBuf, Z);
                #endif
                break;
           }
            ...
            {
                #ifdef __AVX512BW__
                 nrLDPC_cnProc_BG1_R89_AVX512(p_lut, p_procBuf, Z);
                #else
                nrLDPC_cnProc_BG1_R89_AVX2(p_lut, p_procBuf, Z));
                #endif
                break;
           }
    ...
    else
    {
        switch (R)
        {
            ...
            {
                #ifdef __AVX512BW__
                nrLDPC_cnProc_BG2_R15_AVX512(p_lut,p_procBuf, Z);
                #else
                nrLDPC_cnProc_BG2_R15_AVX2(p_lut, p_procBuf, Z);
                #endif
                break;
           }
            ...
            {
                #ifdef __AVX512BW__
                 nrLDPC_cnProc_BG2_R13_AVX512(p_lut,p_procBuf, Z);
                #else
                nrLDPC_cnProc_BG2_R13_AVX2(p_lut, p_procBuf, Z);
                #endif
                break;
           }
            ...
            {
                #ifdef __AVX512BW__
                 nrLDPC_cnProc_BG2_R23_AVX512(p_lut, p_procBuf, Z);
                #else
                nrLDPC_cnProc_BG2_R23_AVX2(p_lut, p_procBuf, Z));
                #endif
                break;
           }
